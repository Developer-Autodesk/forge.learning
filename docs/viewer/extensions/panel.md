...
As each extension should be an separeted JavaScript file, create a file at the UI folder **/js/dockingpanelextension.js** and copy the following content (which is the same as the basic skeleton, except with a different name): 
