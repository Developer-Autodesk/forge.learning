...
By default, a NodeJS project is empty, so we need to install a few packages with **npm install**. Let's start with a basic **express** server, **multer** for file upload, and, of course, **Autodesk Forge**.
