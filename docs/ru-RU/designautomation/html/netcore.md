# Базовый пользовательский интерфейс (UI) (.NET Core)

Давайте начнем с файлов UI (HTML и JavaScript). В папке **wwwroot** создайте папки **bundles** и **js**.
...
К этому моменту  вы можете запустить ваш проект, просто нажмите **play**, и откроется HTML-станица. Это означает, что ваш проект создан корректно. Кнопки работать не будут ... давайте продолжим. 
