...
> Please select .NET Framework 4.7. If not listed, [please install](https://dotnet.microsoft.com/download/thank-you/net47). 3ds Max 2019 requires .NET Framework 4.7 so it should be preinstalled.
